...
import pl.edu.wat.wcy.cop.app.client.ui.pa.GpxTracePropertyAccess;
import pl.edu.wat.wcy.cop.app.shared.domain.sar.GpxTraceDto;
// Displays gpx trace grid data.

public class GpxTraceGrid extends GridPanel<GpxTraceDto> {
     ...
     */
    @Override
    protected ColumnModel<GpxTraceDto> getColumnModel() {
        return DtoGridsConfigs.GPX_TRACE_COLUMN_MODEL;
    }
     ...
     */
    @Override
    protected ModelKeyProvider<GpxTraceDto> getModelKey() {
        return GpxTracePropertyAccess.INSTANCE.key();
    }
     ...
     */
    @Override
    protected Filter<GpxTraceDto, String>[] getFilters() {
        return new Filter[]{};
    }
     ...
     */
    @Override
    protected void showFormForObject(GpxTraceDto model, SelectHandler selectHandler, boolean editable) {
        new GpxTraceForm(model, selectHandler, editable);
    }
     ...
     */
    @Override
    protected GpxTraceDto createNewObject() {

        return new GpxTraceDto();
    }
     ...
     */
    @Override
    protected void objectAdded(GpxTraceDto model) {
     ...
     */
    @Override
    protected void objectRemoved(GpxTraceDto object) {
        // TODO Auto-generated method stub
     ...
     */
    @Override
    protected void objectUpdated(GpxTraceDto object) {
        // TODO Auto-generated method stub
    ...
    protected boolean shouldProcessEvent(ObjectEvent event) {
        return event.getObject() instanceof GpxTraceDto;
    }
}
