...
;(function (root, factory) {
    ...
    function ua(a) {
        this.message = "Assertion failed. See https://openlayers.org/en/v4.3.3/doc/errors/#" + a + " for details.";
        this.code = a;
...
*/
    ...
    function Te(a, b, c) {
        for (var d = 0, e = !1, f, g, h; a.j < b && d < c && 0 < a.b.length;) g = Oe(a)[0], h = g.fb(), f = g.getState(), 5 === f ? e = !0 : 0 !== f || h in a.g || (a.g[h] = !0, ++a.j, ++d, g.load());
        !d && e && a.v()
    }
    ...
    function Df(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        for (var q = n ? n : [NaN, NaN], t = b + d; t < c;) if (Af(a, t - d, t, d, g, h, q), p = Ea(g, h, q[0], q[1]), p < m) {
            m = p;
    ...
    function H(a) {
        ...
        for (var c = "click dblclick mousedown touchstart MSPointerDown pointerdown mousewheel wheel".split(" "), d = 0, e = c.length; d < e; ++d) y(this.D, c[d], Rc);
    ...
    function Rk(a) {
        ...
        if (b && b.c && c) {
            ...
            var g = e[0];
            e = e[1];
            if ("bottom-right" == f || "center-right" == f || "top-right" == f) "" !== a.a.Te && (a.a.Te = b.left = ""), g = Math.round(d[0] - c[0] - g) + "px", a.a.yf != g && (a.a.yf = b.right = g); else {
    ...
    (function (a) {
        ...
        function h(a) {
            for (var b = null, c = a.La() + a.fa; a.fa < c;) b = a.La() >> 3, b = 1 === b ? a.Og() : 2 === b ? a.Lp() : 3 === b ? a.Hp() : 4 === b ? a.Xp() : 5 === b ? a.La() : 6 === b ? a.je() : 7 === b ? a.Fp() : null;
            return b
        }
        ...
        d.prototype.Xh = function () {
            var a = this.Dc;
            a.fa = this.Mf;
            for (var b = a.La() + a.fa, d = 1, e = 0, f = 0, g = 0, h = [], l; a.fa < b;) if (e || (e = a.La(), d = e & 7, e >>= 3), e--, 1 === d || 2 === d) f += a.je(), g += a.je(), 1 === d && (l && h.push(l), l = []), l.push(new c(f, g)); else if (7 === d) l && l.push(l[0].clone()); else throw Error("unknown command " + d);
            l && h.push(l);
            return h
        };
    ...
    lu.prototype.yd = function (a) {
        ...
        a = function (a) {
            ...
            if (d) {
                if (d) {
                    c = !1;
                    if (Array.isArray(d)) for (var e = 0, f = d.length; e < f; ++e) c = iu(p, a, d[e], hu(l, m), this.D, this) || c; else c = iu(p, a, d, hu(l, m), this.D, this) || c;
                    a = c
                } else a = !1;
                this.c = this.c || a
            }
    ...
    k.Nl = function () {
        for (var a = this.Jh(), b = ld(1, 256), c = b.createLinearGradient(0, 0, 1, 256), d = 1 / (a.length - 1), e = 0, f = a.length; e < f; ++e) c.addColorStop(e * d, a[e]);
        b.fillStyle = c;
            ...
            for (var t = 0, u = c.f.length; t < u; ++t) {
                ...
                for (T = z.length; G < T; ++G) {
                    ...
                    if (ta) {
                        ...
                        if (ta) {
                            var Ya = !1;
                            if (Array.isArray(ta)) for (var da = 0, Vb = ta.length; da < Vb; ++da) Ya = iu(ea, U, ta[da], A, this.Pi, this) || Ya; else Ya = iu(ea, U, ta, A, this.Pi, this) || Ya;
                            U = Ya
                        } else U = !1;
                        this.C = this.C || U;
                        l.Td = l.Td || U
    ...
    function ex(a) {
        if (void 0 !== a.resolution) {
            a.features.length = 0;
            for (var b = Ma(), c = a.distance * a.resolution, d = a.source.fe(), e = {}, f = 0, g = d.length; f < g; f++) {
                var h = d[f];
